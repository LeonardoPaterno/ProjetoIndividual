...
insert into marca (nomemarca, ativo) values('Samsung', 'S');
insert into marca (nomemarca, ativo) values('Nokia', 'N');
...
insert into servicos (tiposervico, nomeservico, descricao, ativo) values('Limpeza', 'Limpeza do aparelho', 'Desmontagem e limpeza de componentes, remontagem e teste do aparelho.', 'N');
...
insert into ordemservico (numeroos, observacoes, statusos, pessoa_id, ativo, aparelho_id, servicos_id, orcamento_numero ) values(2,'teste de insert', 'A', 1, 'S', 1, 1, 1);
