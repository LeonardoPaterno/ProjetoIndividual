...
insert into orcamento (total) values(800.59);
...
insert into ordemservico (numeroos, descproblema, descsolucao, dataabertura, dataprazo, datafechamento, statusos, pessoa_id, ativo, aparelho_id, servicos_id, orcamento_numero ) values(1,'teste de insert', '', '2019-08-21', '2019-08-27', null, 'A', 1, 'S', 1, 1, 1);
insert into ordemservico (numeroos, descproblema, descsolucao, dataabertura, dataprazo, datafechamento, statusos, pessoa_id, ativo, aparelho_id, servicos_id, orcamento_numero ) values(2,'teste de insert', '', '2019-08-21', '2019-08-27', null, 'A', 1, 'S', 1, 1, 2);
